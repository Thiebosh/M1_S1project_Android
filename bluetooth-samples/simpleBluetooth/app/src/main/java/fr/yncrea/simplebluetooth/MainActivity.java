package fr.yncrea.simplebluetooth;
...
/**
 * using http://mcuhq.com/27/simple-android-bluetooth-application-with-arduino-example
 * remplacer toggle led par champ texte
 * show paired device doit clear avant d'ajouter des choses
 * RX doit clear avant d'afficher ce qu'il a reçu
 */
        ...
        if (mBTArrayAdapter == null) {
            ...
            mLED1.setOnClickListener(v -> {
                if(mConnectedThread != null) //First check to make sure thread created
                    mConnectedThread.write("123 abc");
            });
